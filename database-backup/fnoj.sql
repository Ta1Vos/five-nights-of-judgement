...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 09 jan 2024 om 15:30
...
(0, 'VHS Tapes', 'categories/VHS.jpg', 'The treasures that contain the lore of the universe of five nights at freddy\'s. All the stories about the characters can be found in these tapes. Some say these are cursed, that if you would watch these, you\'re the next victim.', 11),
(1, 'non-canon', 'categories/non-canon.jpg', 'All the fnaf content that is not in a direct relation to the official five nights at freddy\'s lore.', 5),
(2, 'Game characters', 'categories/characters.jpg', 'All of the five nights at freddy\'s characters that can be found in the official games.  ', 109),
(3, 'Official games', 'categories/official_games.jpg', 'All of the main five night at freddy games that have been made by Scott Cawthon. These may include fnaf-related games he has worked on with others.', 14);
...
(7, 'Henry', 'Tsui', 'henrytsui@rocmondriaan.nl', 'manikbenmoe', 'member');
...
CREATE TABLE `review` (
  ...
  `review_positive_rating` int(11) NOT NULL,
  `review_negative_rating` int(11) NOT NULL,
...
INSERT INTO `review` (`id`, `message`, `rating`, `review_positive_rating`, `review_negative_rating`, `publish_time`, `product_id`, `registered_user_id`) VALUES
(1, 'gbrbbrbrbrbrbrbrr', '5', 0, 0, '2024-01-02 13:53:21', 1, 5),
(2, 'gwrwegwrgrwwgrwrggrwgrwgrw', '10.0', 0, 0, '2024-01-01 15:30:54', 1, 3),
(6, 'doe sthe date work?!?!', '5', 0, 0, '2024-01-01 16:00:00', 1, 7),
(7, 'it work now1kuio2fihjfiruhghrrwfgbiurfvbyhuipr34e2gvurf3gtuvr3`2uivbpyh234`rihvbp3ut4ùt5134gu', '1', 0, 0, '2024-01-01 16:54:23', 1, 7),
(8, 'har har harhar har, har harhar harhar, har har harhar, har har harhar', '9', 0, 0, '2024-01-08 15:18:37', 1, 7),
(9, 'PIZZAAAAAAAAAA', '10', 0, 0, '2024-01-08 15:21:26', 2, 3),
(13, '', '5', 0, 0, '2024-01-09 15:07:33', 3, 7),
(14, 'no', '5', 0, 0, '2024-01-09 15:07:58', 3, 7);
