...
if (count($mostVisited) > 0) {
    ...
    for ($i = 0; $i < count($mostVisited); $i++) {
        ...
        $frequentlyVisitedCategories .= "<div class='card bg-dark mx-2 border border-3 border-dark rounded-2' style='width: 18rem;'>
  ...
  <a href='/category/{$category["id"]}' class='stretched-link'></a>
    ...
    $frequentlyVisitedCategories = "<b class='text-light'>Something went wrong</b>";
}

//var_dump($frequentlyVisitedCategories);
//echo "<br><br>";
