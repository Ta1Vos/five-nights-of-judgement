    ...
    <div class="bg-black text-light text-center p-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/category/<?php if(isset($product->category_id)){$product->category_id;} ?>">Products</a></li>
                <li class="breadcrumb-item"><a href="/product/<?php if(isset($params[2])){$params[2];} ?>"><?= $product->name ?></a></li>
            </ol>
        </nav>
        <div class="row gy-3">
            <!--
